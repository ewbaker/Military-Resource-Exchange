...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-af sticky-top">
        <div class="container-fluid px-4">
            <a class="navbar-brand fw-bold tracking-tighter" href="<?php echo e(route('welcome')); ?>">
            ...
            <div class="ms-auto d-flex align-items-center">
                <?php if(auth()->guard()->check()): ?>
                    <div class="dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center text-white" href="#" role="button" data-bs-toggle="dropdown">
                            <div class="account-circle me-2"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></div>
                            <span><?php echo e(Auth::user()->name); ?></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end mt-2 shadow border-0">
                            <li><a class="dropdown-item" href="<?php echo e(route('profile.edit')); ?>">Account Settings</a></li>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light btn-sm">LOGIN</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
    ...
    <div class="d-flex">
        ...
        <nav class="sidebar">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('welcome') ? 'active' : ''); ?>" href="<?php echo e(route('welcome')); ?>">🏠 Main Menu / Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('items.index') ? 'active' : ''); ?>" href="<?php echo e(route('items.index')); ?>">📦 Equipment Catalog</a>
                </li>
                <?php if(auth()->guard()->check()): ?>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">🪖 My Possessions</a>
                </li>
                <?php if(Auth::user()->role == 'lender'): ?>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('items.create') ? 'active' : ''); ?>" href="<?php echo e(route('items.create')); ?>">➕ List New Gear (AI)</a>
                </li>
                <?php endif; ?>
                <!-- NEW REVIEW/APPEAL LINK -->
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('reviews.create') ? 'active' : ''); ?>" href="<?php echo e(route('reviews.create')); ?>">📢 Submit Review/Appeal</a>
                </li>
                <?php endif; ?>
            </ul>
...
</html><?php /**PATH C:\wamp64\www\Military-Resource-Exchange\resources\views/layouts/app.blade.php ENDPATH**/ ?>